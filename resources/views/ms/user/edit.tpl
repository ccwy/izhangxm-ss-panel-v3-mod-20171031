                            ...
                            <div class="card-inner">
                                ...
                                <div class="card-action">
                                    <div class="card-action-btn pull-left">
                                        <button class="btn btn-flat waves-attach" id="pwd-update"><span class="icon">check</span>&nbsp;提交
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card margin-bottom-no">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="card-action">
                                    <div class="card-action-btn pull-left">
                                        <button class="btn btn-flat waves-attach" id="ss-pwd-update"><span class="icon">check</span>&nbsp;提交
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card margin-bottom-no">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="card-action">
                                    <div class="card-action-btn pull-left">
                                        <button class="btn btn-flat waves-attach" id="method-update"><span class="icon">check</span>&nbsp;提交
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card margin-bottom-no">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="card-action">
                                    <div class="card-action-btn pull-left">
                                        <button class="btn btn-flat waves-attach" id="wechat-update"><span class="icon">check</span>&nbsp;提交
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card margin-bottom-no">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="card-action">
                                    <div class="card-action-btn pull-left">
                                        <button class="btn btn-flat waves-attach" id="ssr-update"><span class="icon">check</span>&nbsp;提交
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card margin-bottom-no">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="card-action">
                                    <div class="card-action-btn pull-left">
                                        <button class="btn btn-flat waves-attach" id="theme-update"><span class="icon">check</span>&nbsp;提交
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card margin-bottom-no">
                        <div class="card-main">
                            <div class="card-inner">
                                ...
                                <div class="card-action">
                                    <div class="card-action-btn pull-left">
                                        <button class="btn btn-flat waves-attach" id="mail-update"><span class="icon">check</span>&nbsp;提交
                                        </button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-inner">
                                ...
                                <div class="card-action">
                                    <div class="card-action-btn pull-left">
                                        ...
                                        <button class="btn btn-flat waves-attach" id="ga-test"><span class="icon">extension</span>&nbsp;测试
                                        </button>
                        ...
                        <div class="card-main">
                            <div class="card-inner">
                                <div class="card-inner">
                                    ...
                                    <p>格式参看<a href="https://adblockplus.org/zh_CN/filters">https://adblockplus.org/zh_CN/filters</a>
                                    </p>
                            ...
                            <div class="card-main">
                                <div class="card-inner">
                                    <div class="card-inner">
                                        ...
                                        <p>Telegram 添加机器人账号 <a href="https://t.me/{$telegram_bot}">@{$telegram_bot}</a>，拍下下面这张二维码发给它。
                                        </p>
                                        <div class="form-group form-group-label">
                                            <div class="text-center">
                                    ...
                                    <div class="card-action">
                                        <div class="card-action-btn pull-left">
                                            <a class="btn btn-brand-accent btn-flat waves-attach"
                                               href="/user/telegram_reset"><span class="icon">format_color_reset</span>&nbsp;解绑</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
