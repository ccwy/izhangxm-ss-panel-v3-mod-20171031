...
class AuthController extends BaseController
{
    public function login()
    {
        ...
        return $this->view()->assign('geetest_html', $GtSdk)->assign('login_token', $login_token)->assign('login_number', $login_number)->assign('telegram_bot', Config::get('telegram_bot'))->display('guest/login.tpl');
    }
    ...
    public function register($request, $response, $next)
    {
        ...
        return $this->view()->assign('enable_invite_code', Config::get('enable_invite_code'))->assign('geetest_html', $GtSdk)->assign('enable_email_verify', Config::get('enable_email_verify'))->assign('code', $code)->display('guest/register.tpl');
    }
